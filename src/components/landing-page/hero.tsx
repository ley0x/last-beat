...
export const Hero = () => {
  ...
  return (
    <section className="relative bg-[url(/artists/sly-and-the-family-stone.webp)] bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex h-screen lg:items-center lg:px-8">
        <div className="max-w-4xl text-center ltr:sm:text-left rtl:sm:text-right">
          <h1 className="text-3xl font-extrabold text-white sm:text-5xl">
            <strong className="text-6xl block font-extrabold text-primary">Last Beat</strong>
            The Rhythm of Your Life, Quantified
          </h1>

          <p className="mt-4 max-w-6xl text-white/90 sm:text-xl/relaxed">
            Unlock the power of your music habits with Last Beat. Gain insights into how music shapes your life and
            share your unique rhythm with the world. Dive deep into your audio history and let the data tell your story.
          </p>
      ...
      <ChevronDown
        ...
        className="absolute bottom-0 left-1/2 -translate-x-1/2 h-12 w-12 mb-2 cursor-pointer text-white animate-bounce"
      />
    </section>
  )
}
