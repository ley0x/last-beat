    ...
    <section className="py-5 bg-card-foreground/5">
      <Wrapper className="flex-wrap gap-5 justify-center">
        ...
        <div className="flex flex-col grow">
          ...
          <Header as="h3" className="text-md">
            Check out your recently{' '}
            <span className="underline decoration-primary underline-2 underline-offset-2">top-played</span> albums,
            tracks, and artists!
          </Header>
          <ul className="list-disc list-inside">
            <li>
              Playcount: <strong className="text-primary">{beautifyNumber(parseInt(data.playcount ?? '0', 10))}</strong>
            </li>
            <li>
              Albums: <strong className="text-primary">{beautifyNumber(parseInt(data.album_count ?? '0', 10))}</strong>
            </li>
            <li>
              Tracks: <strong className="text-primary">{beautifyNumber(parseInt(data.track_count ?? '0', 10))}</strong>
            </li>
          </ul>
        </div>
      </Wrapper>
