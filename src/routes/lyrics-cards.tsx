  ...
  return (
    <Main className="max-w-svw overflow-x-hidden px-2 sm:px-5 flex-col">
      <Wrapper className="flex-col gap-8">
        <header>
          <Header as="h1">
            Create awesome <span className="text-red-400 hover:underline text-decoration-primary">cards</span> with your
            favorite <span className="text-red-400 hover:underline text-decoration-primary">lyrics</span>.
          </Header>
              ...
              <CardHeader>
                <div className="flex flew-wrap justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Make your lyrics cards look unique and personalize them with your favorite colors, images and
                      more.
                    </CardDescription>
                  </div>
                  <ResetButton />
